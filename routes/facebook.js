...
router.post('/', function(req,res){
  ...
  request('https://graph.facebook.com/v2.9/search?q='+influencerName+'&type=page&access_token=TOKEN HERE', function (error, reqResponse, body) {
   ...
   try{
    ...
    //time to make another request... another one!
     request('https://graph.facebook.com/v2.9/'+id+'?fields=about,picture.width(800).height(800),engagement,name,username&access_token=TOKEN HERE', function (error, reqResponse, body) {
       try{
