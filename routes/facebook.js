  ...
  request('https://graph.facebook.com/v2.9/search?q='+influencerName+'&type=page&access_token=TOKENHERE', function (error, reqResponse, body) {
   ...
   try{
    ...
    //time to make another request... another one!
     request('https://graph.facebook.com/v2.9/'+id+'?fields=bio,picture.width(800).height(800),engagement,name,username,posts.limit(12){likes.summary(true),comments.summary(true)}&access_token=TOKENHERE', function (error, reqResponse, body) {
       try{
